...
categorical_features = ['RevLineCr', 'LowDoc', 'UrbanRural', 'State', 'Sector',  'RevLineCr_LowDoc_risk_indicator', 'Franchise_risk_factor', 'Lender_Borrower_SameState', 'ApprovalFY_Term',
